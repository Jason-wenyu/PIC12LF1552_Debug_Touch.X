# 1 "mcc_generated_files/mtouch/mtouch_sensor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/mtouch/mtouch_sensor.c" 2
# 36 "mcc_generated_files/mtouch/mtouch_sensor.c"
...
# 36 "mcc_generated_files/mtouch/mtouch_sensor.c" 2
...
# 37 "mcc_generated_files/mtouch/mtouch_sensor.c" 2



# 1 "mcc_generated_files/mtouch/mtouch_random.h" 1
# 62 "mcc_generated_files/mtouch/mtouch_random.h"
    uint8_t MTOUCH_Random(void);
# 40 "mcc_generated_files/mtouch/mtouch_sensor.c" 2


# 1 "mcc_generated_files/mtouch/mtouch_sensor.h" 1
# 40 "mcc_generated_files/mtouch/mtouch_sensor.h"
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 40 "mcc_generated_files/mtouch/mtouch_sensor.h" 2
...
# 42 "mcc_generated_files/mtouch/mtouch_sensor.c" 2

# 1 "mcc_generated_files/mtouch/mtouch_sensor_scan.h" 1
# 39 "mcc_generated_files/mtouch/mtouch_sensor_scan.h"
# 1 "mcc_generated_files/mtouch/mtouch_config.h" 1
# 42 "mcc_generated_files/mtouch/mtouch_config.h"
...
# 39 "mcc_generated_files/mtouch/mtouch_sensor_scan.h" 2
...
static __attribute__((inline)) void Sensor_setSampled (mtouch_sensor_t* sensor);
static __attribute__((inline)) void Sensor_Sampled_Reset (mtouch_sensor_t* sensor);
static __attribute__((inline)) void Sensor_setActive (mtouch_sensor_t* sensor);
static __attribute__((inline)) void Sensor_setInactive (mtouch_sensor_t* sensor);
static _Bool Sensor_isEnabled (mtouch_sensor_t* sensor);
...
static _Bool lowpowerActivated = 0;
...
static mtouch_sensor_t mtouch_sensor[1u] ={
    {Sensor_AN4,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32u,0,0,0,0},
};
...
# 185 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 1u; sensor++)
...
# 213 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isAnySensorActive(void)
{
    enum mtouch_sensor_names sensor;
...
static enum mtouch_sensor_error Sensor_Acquisition(mtouch_sensor_t* sensor)
{
    ...
    if((mtouch_sensor_packetsample_t)abs(packet_sample - sensor->rawSample) > 100u)
    {
...
# 376 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{

    mtouch_sensor_adcsample_t result = ADRES;
...
#pragma switch time
 switch(packet_counter & 0x01)
        ...
        if(packet_counter!=mtouch_sensor[currentScannSensor].oversampling)
        {
            ...
            {
                result = ((mtouch_sensor_adcsample_t)1024u) - result;
            }
...
# 472 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 1u)
...
{
    if(sensor!=((void*)0))
        return (_Bool)sensor->enabled;
    else
        return 0;
}
# 507 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 544 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
