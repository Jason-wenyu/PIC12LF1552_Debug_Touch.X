# 1 "mcc_generated_files/mtouch/mtouch_sensor_scan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/mtouch/mtouch_sensor_scan.c" 2
# 36 "mcc_generated_files/mtouch/mtouch_sensor_scan.c"
...
# 36 "mcc_generated_files/mtouch/mtouch_sensor_scan.c" 2
...
void MTOUCH_CVD_ScanA_0(void)
{
    ...
    __asm("BANKSEL        " "LATA");
    __asm("bsf            " "LATA" " & 0x7F," "5");


    __asm("BANKSEL        ADCON0");
    __asm("movlw          " "( 0x4<<2 | 0x1 )");
    ...
    __asm("movwf          ADCON0 & 0x7F");
    __asm("BANKSEL        " "LATA");
    __asm("bcf            " "LATA" " & 0x7F," "5");
    __asm("BANKSEL        ADCON0");


    __asm("movlw LOW      " "TRISA");
    __asm("movwf          FSR0L & 0x7F");
    __asm("movlw HIGH     " "TRISA");
    __asm("movwf          FSR0H & 0x7F");


    __asm("movlw LOW      " "LATA");
    __asm("movwf          FSR1L & 0x7F");
    __asm("movlw HIGH     " "LATA");
    __asm("movwf          FSR1H & 0x7F");


    __asm("movlw          " "( 0x4<<2 | 0x1 )");
    __asm("bsf            INDF0 & 0x7F, " "5");
    _delay(0u);
    __asm("movwf          ADCON0 & 0x7F");
