# 1 "mcc_generated_files/mtouch/mtouch_random.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/mtouch/mtouch_random.c" 2
# 36 "mcc_generated_files/mtouch/mtouch_random.c"
...
# 36 "mcc_generated_files/mtouch/mtouch_random.c" 2
...
# 66 "mcc_generated_files/mtouch/mtouch_random.c"
uint8_t MTOUCH_Random(void)
{
    ...
    else
    {
        ...
        seed = seed >> (uint8_t)1;
        seed = seed ^ (MTOUCH_RANDOM_t)0xB4;
    }
